...
// Keyboard USB Modem ID: /dev/tty.usbmodem1411
...
[_DEFAULT] = { /* qwerty */
        { KC_GRV,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_TRNS,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS },
        ...
        { KC_ESC,  KC_LGUI, KC_LALT, KC_BSLS,  MO(_NAV),KC_SPC,  KC_ENT,   KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RBRC }
},
